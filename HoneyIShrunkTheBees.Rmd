...
```{r}
pacman::p_load(choroplethr, choroplethrMaps, RODBC, stringr, dplyr, tidyr, inference)
#library(choroplethr)
...
We'll first need to know which column 'HONEY - PRODUCTION, MEASURED IN LB / COLONY' is stored in:
...
As the results of this inference test for the hypothesis test goes, we again fail to reject the null since the p-value is fairly large (>0.05).
